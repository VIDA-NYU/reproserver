 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class se extends oe{}se.directiveName="unsafeSVG",se.resultType=2;const le=ae(se),ce=ae(class extends re{constructor(e){var t;if(super(e),e.type!==te||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const a=e[i];return null==a?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ct){this.ct=new Set;for(const e in t)this.ct.add(e);return this.render(t)}this.ct.forEach((e=>{null==t[e]&&(this.ct.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const a=t[e];null!=a&&(this.ct.add(e),e.includes("-")?i.setProperty(e,a):i[e]=a)}return T}});var de=__webpack_require__(9886),he=__webpack_require__(4841),fe=__webpack_require__.n(he);const pe="./w/api",ue=r(de.Z);function be(e){return[ue,e]}const me=window.IS_APP||window.electron&&window.electron.IS_APP||window.matchMedia("(display-mode: standalone)").matches,ge="1.6.2";function ve(e){" "==e.key&&(e.preventDefault(),e.target.click())}class we extends X{constructor(){super(),this.size="1.1em",this.width=null,this.height=null}static get properties(){return{svg:{type:String},size:{type:String},width:{type:String},height:{type:String}}}static get styles(){return o`
    :host {
    ...
    `}render(){if(!this.svg)return U``;const e={};return this.size?(e.width=this.size,e.height=this.size):(this.width&&(e.width=this.width),this.height&&(e.height=this.height)),U`<svg style="${ce(e)}"><g>${le(this.svg)}</g></svg>`}}customElements.define("fa-icon",we),customElements.define("wr-anim-logo",class extends we{constructor(){super(),this.svg=fe()}static get styles(){return o`
    #wrlogo #stop5687 {
    ...
    </div>`}onClose(){this.dispatchEvent(new CustomEvent("modal-closed"))}});var xe;function ke(e,t){void 0===t&&(t={});var i=t.registrationOptions;void 0===i&&(i={}),delete t.registrationOptions;var a=function(e){for(var i=[],a=arguments.length-1;a-- >0;)i[a]=arguments[a+1];t&&t[e]&&t[e].apply(t,i)};"serviceWorker"in navigator&&xe.then((function(){Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))?(!function(e,t,i){fetch(e).then((function(a){404===a.status?(t("error",new Error("Service worker not found at "+e)),_e()):-1===a.headers.get("content-type").indexOf("javascript")?(t("error",new Error("Expected "+e+" to have javascript content-type, but received "+a.headers.get("content-type"))),_e()):$e(e,t,i)})).catch((function(e){return ye(t,e)}))}(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return ye(a,e)}))):($e(e,a,i),navigator.serviceWorker.ready.then((function(e){a("ready",e)})).catch((function(e){return ye(a,e)})))}))}function ye(e,t){navigator.onLine||e("offline"),e("error",t)}function $e(e,t,i){navigator.serviceWorker.register(e,i).then((function(e){t("registered",e),e.waiting?t("updated",e):e.onupdatefound=function(){t("updatefound",e);var i=e.installing;i.onstatechange=function(){"installed"===i.state&&(navigator.serviceWorker.controller?t("updated",e):t("cached",e))}}})).catch((function(e){return ye(t,e)}))}function _e(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then((function(e){e.unregister()})).catch((function(e){return ye(emit,e)}))}"undefined"!=typeof window&&(xe="undefined"!=typeof Promise?new Promise((function(e){return window.addEventListener("load",e)})):{then:function(e){return window.addEventListener("load",e)}});let Se="ReplayWeb.page";function ze(e){Se=e}function Ce(e="sw.js",t="./"){let i,a;const r=new Promise(((e,t)=>{i=e,a=t})),o=Ae();return o&&(console.error(o),a(o)),ke(t+e,{registrationOptions:{scope:t},registered(){console.log("Service worker is registered"),i()},error(e){console.error("Error during service worker registration:",e),a(`${Se} could not be loaded due to the following error:\n${e.toString()}`)}}),r}function Ae(){return navigator.serviceWorker?null:"http:"===window.location.protocol?`Sorry, the ${Se} system must be loaded from an HTTPS URL, but was loaded from: ${window.location.host}.\nPlease try loading this page from an HTTPS URL`:`Sorry, ${Se} won't work in this browser as Service Workers are not supported.\nPlease try a different browser.\n(Service Workers are disabled in Firefox in Private Mode. If Using Private Mode in Firefox, try regular mode)`}function Ie(e){let t=null;try{t=new Date(e.ts||e.date)}catch(e){}const i=t&&!isNaN(t)?De(t.toISOString()):"";return{date:t,timestamp:i}}function De(e){return e.replace(/[-:T]/g,"").slice(0,14)}function Le(e,t,i){const a=new URLSearchParams;return a.set("view",e),a.set("url",t),a.set("ts",i),"#"+a.toString()}async function Ee(e){const t=await async function(e,t){const i=(new TextEncoder).encode(e),a=await crypto.subtle.digest(t,i),r=Array.from(new Uint8Array(a)).map((e=>e.toString(16).padStart(2,"0"))).join("");return r}(e,"SHA-256");return{url:e,coll:"id-"+t.slice(0,12)}}var Pe=__webpack_require__(8200),Ue=__webpack_require__.n(Pe),Te=__webpack_require__(4878),Re=__webpack_require__.n(Te),qe=__webpack_require__(4124),Me=__webpack_require__.n(qe);class Ne extends X{constructor(e="sw.js"){super(),this.sourceUrl=null,this.collTitle=null,this.showAbout=!1,this.pageParams=new URLSearchParams,this.inited=!1,this.navMenuShown=!1,this.collPageUrl="",this.pageTitle="",this.pageReplay=!1,this.loadInfo=null,e&&Ce(e),this.safariKeyframes()}get appName(){return"ReplayWeb.page"}get homeUrl(){return window.location.pathname}static get properties(){return{inited:{type:Boolean},pageParams:{type:Object},sourceUrl:{type:String},navMenuShown:{type:Boolean},showAbout:{type:Boolean},collTitle:{type:String},loadInfo:{type:Object},embed:{type:String},collPageUrl:{type:String},pageTitle:{type:String},pageReplay:{type:Boolean},source:{type:String}}}static get styles(){return be(Ne.appStyles)}static get appStyles(){return o`
    #wrlogo {
      max-height: 1.0rem;
    }
    .navbar {
        ...
        <div class="navbar-start">
          ${me?U`
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Back" @click="${()=>window.history.back()}" @keyup="${ve}">
              <fa-icon size="1.0rem" .svg="${Re()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Back</span>
            </a>
            <a role="button" href="#" class="navbar-item arrow-button" title="Go Forward" @click="${()=>window.history.forward()}" @keyup="${ve}">
              <fa-icon size="1.0rem" .svg="${Me()}" aria-hidden="true"></fa-icon><span class="menu-only is-size-7">&nbsp;Go Forward</span>
            </a>
          `:""}
        </div>
        ${this.embed?U``:U`
    ...
    `:U``}firstUpdated(){this.initRoute(),window.addEventListener("popstate",(()=>{this.initRoute()}))}updated(e){e.has("sourceUrl")&&(this.collTitle=null)}onFavIcons(e){const t=document.querySelector("head"),i=document.querySelectorAll("link[rel*='icon']");for(const e of i)t.removeChild(e);for(const i of e.detail.icons){const e=document.createElement("link");e.rel=i.rel,e.href=i.href,t.appendChild(e)}}skipMenu(e){e.preventDefault(),this.renderRoot.querySelector("#skip-main-target").focus()}onNavMenu(e){e.preventDefault(),e.stopPropagation(),this.navMenuShown=!this.navMenuShown,this.navMenuShown&&(document.addEventListener("click",(e=>{e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus()}),{once:!0}),document.addEventListener("keypress",(e=>{"Escape"==e.key&&(e.preventDefault(),this.navMenuShown=!1,this.renderRoot.querySelector("#menu-button").focus())}),{once:!0}))}initRoute(){this.inited=!0,this.pageParams=new URLSearchParams(window.location.search);let e=this.pageParams.get("state");if(e)try{if(e=JSON.parse(e),e.ids instanceof Array&&e.userId&&"open"===e.action)return this.pageParams.set("source","googledrive://"+e.ids[0]),this.pageParams.delete("state"),void(window.location.search=this.pageParams.toString())}catch(e){console.log(e)}if(this.source){this.pageParams.set("source",this.source);const e=new URL(window.location.href);e.search=this.pageParams.toString(),window.history.replaceState({},document.title,e.href)}if(this.sourceUrl=this.pageParams.get("source")||"",this.embed=this.pageParams.get("embed")||"",this.pageParams.has("terms")&&(this.showAbout=!0),this.pageParams.get("config")){this.loadInfo||(this.loadInfo={});try{this.loadInfo.extraConfig=JSON.parse(this.pageParams.get("config"))}catch(e){console.log("invalid config: "+e)}}if(this.pageParams.get("basePageUrl")&&(this.loadInfo||(this.loadInfo={extraConfig:{}}),this.loadInfo.extraConfig||(this.loadInfo.extraConfig={}),this.loadInfo.extraConfig.baseUrl=this.pageParams.get("basePageUrl")),this.pageParams.get("customColl")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.customColl=this.pageParams.get("customColl")),"1"===this.pageParams.get("noWebWorker")&&(this.loadInfo||(this.loadInfo={}),this.loadInfo.noWebWorker=!0),me&&this.sourceUrl.startsWith("file://")){const e=new URL("http://files.archiveweb.page/");e.searchParams.set("filename",this.sourceUrl.slice("file://".length)),this.loadInfo={sourceUrl:this.sourceUrl,loadUrl:e.href}}}onStartLoad(e){this.pageParams.set("source",e.detail.sourceUrl);const t=new URL(window.location.href);t.search=this.pageParams.toString(),this.collPageUrl=t.toString(),e.detail.isFile?(window.history.pushState({},"",this.collPageUrl),this.sourceUrl=e.detail.sourceUrl,this.loadInfo=e.detail):window.location.search=this.pageParams.toString()}onCollLoaded(e){this.loadInfo=null,e.detail.collInfo&&(this.collTitle=e.detail.collInfo.title),e.detail.alreadyLoaded||e.detail.sourceUrl!==this.sourceUrl&&(this.pageParams.set("source",e.detail.sourceUrl),window.location.search=this.pageParams.toString())}onTitle(e){e.detail.title&&(this.pageTitle=e.detail.title,this.pageReplay=e.detail.replayTitle,document.title=(e.detail.replayTitle?"Archive of ":"")+this.pageTitle+" | "+this.appName)}safariKeyframes(){const e=document.createElement("style");document.head.appendChild(e),e.appendChild(document.createTextNode("\n    @keyframes spinAround {\n      from {\n        transform: rotate(0deg);\n      }\n      to {\n        transform: rotate(359deg);\n      }\n    }\n    "))}renderAbout(){return U`
      <div class="modal is-active">
  ...
  `)}render(){return U`
      ...
      <div class="panel">
        ...
        ${this.renderSearchHeader()}
          <div class="control has-icons-left has-addons">
            ...
            <span class="icon is-left is-small"><fa-icon .svg="${Ye()}"/></span>
          </div>
          <wr-sorter id="index"
          sortKey="ctime"
          ?sortDesc="${!0}"
    ...
    `}renderCollInfo(e){return U`<wr-coll-info .coll=${e}></wr-coll-info>`}renderEmpty(){return U`<i>No Archives so far! Archives loaded in the section above will appear here.</i>`}}class Xe extends X{constructor(){super(),this.detailed=!1,this.canDelete=!1}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},canDelete:{type:Boolean}}}static get styles(){return be(Xe.compStyles)}static get compStyles(){return o`
    .columns {
      width: 100%;
    }
    .column {
    ...
    `}render(){const e=this.coll,t=this.detailed;return U`
      ...
      </div>`}onCopy(e,t){return e.preventDefault(),e.stopPropagation(),navigator.clipboard.writeText(t),!1}onPurge(e){const t={reload:e};this.dispatchEvent(new CustomEvent("coll-purge",{detail:t}))}}customElements.define("wr-coll-info",Xe),customElements.define("wr-coll-index",Je);var et=__webpack_require__(5056),tt=__webpack_require__.n(et),it=__webpack_require__(5732),at=__webpack_require__.n(it),rt=__webpack_require__(8561),ot=__webpack_require__.n(rt),nt=__webpack_require__(9885),st=__webpack_require__.n(nt),lt=__webpack_require__(4636),ct=__webpack_require__.n(lt),dt=__webpack_require__(1615),ht=__webpack_require__.n(dt),ft=__webpack_require__(2302),pt=__webpack_require__.n(ft),ut=__webpack_require__(6368),bt=__webpack_require__.n(ut),mt=__webpack_require__(9125),gt=__webpack_require__.n(mt),vt=__webpack_require__(9998),wt=__webpack_require__.n(vt),xt=__webpack_require__(2164),kt=__webpack_require__.n(xt),yt=__webpack_require__(426),$t=__webpack_require__.n(yt),_t=__webpack_require__(430),St=__webpack_require__.n(_t),zt="undefined"!=typeof window?window:null,Ct=null===zt,At=Ct?void 0:zt.document,It="horizontal",Dt=function(){return!1},Lt=Ct?"calc":["","-webkit-","-moz-","-o-"].filter((function(e){var t=At.createElement("div");return t.style.cssText="width:"+e+"calc(9px)",!!t.style.length})).shift()+"calc",Et=function(e){return"string"==typeof e||e instanceof String},Pt=function(e){if(Et(e)){var t=At.querySelector(e);if(!t)throw new Error("Selector "+e+" did not match a DOM element");return t}return e},Ut=function(e,t,i){var a=e[t];return void 0!==a?a:i},Tt=function(e,t,i,a){if(t){if("end"===a)return 0;if("center"===a)return e/2}else if(i){if("start"===a)return 0;if("center"===a)return e/2}return e},Rt=function(e,t){var i=At.createElement("div");return i.className="gutter gutter-"+t,i},qt=function(e,t,i){var a={};return Et(t)?a[e]=t:a[e]=Lt+"("+t+"% - "+i+"px)",a},Mt=function(e,t){var i;return(i={})[e]=t+"px",i};const Nt=function(e,t){if(void 0===t&&(t={}),Ct)return{};var i,a,r,o,n,s,l=e;Array.from&&(l=Array.from(l));var c=Pt(l[0]).parentNode,d=getComputedStyle?getComputedStyle(c):null,h=d?d.flexDirection:null,f=Ut(t,"sizes")||l.map((function(){return 100/l.length})),p=Ut(t,"minSize",100),u=Array.isArray(p)?p:l.map((function(){return p})),b=Ut(t,"maxSize",1/0),m=Array.isArray(b)?b:l.map((function(){return b})),g=Ut(t,"expandToMin",!1),v=Ut(t,"gutterSize",10),w=Ut(t,"gutterAlign","center"),x=Ut(t,"snapOffset",30),k=Ut(t,"dragInterval",1),y=Ut(t,"direction",It),$=Ut(t,"cursor",y===It?"col-resize":"row-resize"),_=Ut(t,"gutter",Rt),S=Ut(t,"elementStyle",qt),z=Ut(t,"gutterStyle",Mt);function C(e,t,a,r){var o=S(i,t,a,r);Object.keys(o).forEach((function(t){e.style[t]=o[t]}))}function A(){return s.map((function(e){return e.size}))}function I(e){return"touches"in e?e.touches[0][a]:e[a]}function D(e){var t=s[this.a],i=s[this.b],a=t.size+i.size;t.size=e/this.size*a,i.size=a-e/this.size*a,C(t.element,t.size,this._b,t.i),C(i.element,i.size,this._c,i.i)}function L(e){var i,a=s[this.a],r=s[this.b];this.dragging&&(i=I(e)-this.start+(this._b-this.dragOffset),k>1&&(i=Math.round(i/k)*k),i<=a.minSize+x+this._b?i=a.minSize+this._b:i>=this.size-(r.minSize+x+this._c)&&(i=this.size-(r.minSize+this._c)),i>=a.maxSize-x+this._b?i=a.maxSize+this._b:i<=this.size-(r.maxSize-x+this._c)&&(i=this.size-(r.maxSize+this._c)),D.call(this,i),Ut(t,"onDrag",Dt)(A()))}function E(){var e=s[this.a].element,t=s[this.b].element,a=e.getBoundingClientRect(),n=t.getBoundingClientRect();this.size=a[i]+n[i]+this._b+this._c,this.start=a[r],this.end=a[o]}function P(e){var t=function(e){if(!getComputedStyle)return null;var t=getComputedStyle(e);if(!t)return null;var i=e[n];return 0===i?null:i-=y===It?parseFloat(t.paddingLeft)+parseFloat(t.paddingRight):parseFloat(t.paddingTop)+parseFloat(t.paddingBottom)}(c);if(null===t)return e;if(u.reduce((function(e,t){return e+t}),0)>t)return e;var i=0,a=[],r=e.map((function(r,o){var n=t*r/100,s=Tt(v,0===o,o===e.length-1,w),l=u[o]+s;return n<l?(i+=l-n,a.push(0),l):(a.push(n-l),n)}));return 0===i?e:r.map((function(e,r){var o=e;if(i>0&&a[r]-i>0){var n=Math.min(i,a[r]-i);i-=n,o=e-n}return o/t*100}))}function U(){var e=this,i=s[e.a].element,a=s[e.b].element;e.dragging&&Ut(t,"onDragEnd",Dt)(A()),e.dragging=!1,zt.removeEventListener("mouseup",e.stop),zt.removeEventListener("touchend",e.stop),zt.removeEventListener("touchcancel",e.stop),zt.removeEventListener("mousemove",e.move),zt.removeEventListener("touchmove",e.move),e.stop=null,e.move=null,i.removeEventListener("selectstart",Dt),i.removeEventListener("dragstart",Dt),a.removeEventListener("selectstart",Dt),a.removeEventListener("dragstart",Dt),i.style.userSelect="",i.style.webkitUserSelect="",i.style.MozUserSelect="",i.style.pointerEvents="",a.style.userSelect="",a.style.webkitUserSelect="",a.style.MozUserSelect="",a.style.pointerEvents="",e.gutter.style.cursor="",e.parent.style.cursor="",At.body.style.cursor=""}function T(e){if(!("button"in e)||0===e.button){var i=this,a=s[i.a].element,r=s[i.b].element;i.dragging||Ut(t,"onDragStart",Dt)(A()),e.preventDefault(),i.dragging=!0,i.move=L.bind(i),i.stop=U.bind(i),zt.addEventListener("mouseup",i.stop),zt.addEventListener("touchend",i.stop),zt.addEventListener("touchcancel",i.stop),zt.addEventListener("mousemove",i.move),zt.addEventListener("touchmove",i.move),a.addEventListener("selectstart",Dt),a.addEventListener("dragstart",Dt),r.addEventListener("selectstart",Dt),r.addEventListener("dragstart",Dt),a.style.userSelect="none",a.style.webkitUserSelect="none",a.style.MozUserSelect="none",a.style.pointerEvents="none",r.style.userSelect="none",r.style.webkitUserSelect="none",r.style.MozUserSelect="none",r.style.pointerEvents="none",i.gutter.style.cursor=$,i.parent.style.cursor=$,At.body.style.cursor=$,E.call(i),i.dragOffset=I(e)-i.end}}y===It?(i="width",a="clientX",r="left",o="right",n="clientWidth"):"vertical"===y&&(i="height",a="clientY",r="top",o="bottom",n="clientHeight"),f=P(f);var R=[];function q(e){var t=e.i===R.length,i=t?R[e.i-1]:R[e.i];E.call(i);var a=t?i.size-e.minSize-i._c:e.minSize+i._b;D.call(i,a)}return s=l.map((function(e,t){var a,r={element:Pt(e),size:f[t],minSize:u[t],maxSize:m[t],i:t};if(t>0&&((a={a:t-1,b:t,dragging:!1,direction:y,parent:c})._b=Tt(v,t-1==0,!1,w),a._c=Tt(v,!1,t===l.length-1,w),"row-reverse"===h||"column-reverse"===h)){var o=a.a;a.a=a.b,a.b=o}if(t>0){var n=_(t,y,r.element);!function(e,t,a){var r=z(i,t,a);Object.keys(r).forEach((function(t){e.style[t]=r[t]}))}(n,v,t),a._a=T.bind(a),n.addEventListener("mousedown",a._a),n.addEventListener("touchstart",a._a),c.insertBefore(n,r.element),a.gutter=n}return C(r.element,r.size,Tt(v,0===t,t===l.length-1,w),t),t>0&&R.push(a),r})),s.forEach((function(e){var t=e.element.getBoundingClientRect()[i];t<e.minSize&&(g?q(e):e.minSize=t)})),{setSizes:function(e){var t=P(e);t.forEach((function(e,i){if(i>0){var a=R[i-1],r=s[a.a],o=s[a.b];r.size=t[i-1],o.size=e,C(r.element,r.size,a._b,r.i),C(o.element,o.size,a._c,o.i)}}))},getSizes:A,collapse:function(e){q(s[e])},destroy:function(e,t){R.forEach((function(a){if(!0!==t?a.parent.removeChild(a.gutter):(a.gutter.removeEventListener("mousedown",a._a),a.gutter.removeEventListener("touchstart",a._a)),!0!==e){var r=S(i,a.a.size,a._b);Object.keys(r).forEach((function(e){s[a.a].element.style[e]="",s[a.b].element.style[e]=""}))}}))},parent:c,pairs:R}},Bt="search://";class jt extends X{constructor(){super(),this.sourceUrl=null,this.inited=!1,this.isLoading=!1,this.coll="",this.collInfo=null,this._replaceLoc=!1,this._locUpdateNeeded=!1,this._locationHash="",this.tabData={},this.url="",this.ts="",this.tabNames=["pages","story","resources","info"],this.tabLabels={pages:"Pages",story:"Story",resources:"URLs",info:"Archive Info"},this.menuActive=!1,this.hasStory=!1,this.editable=!1,this.browsable=!0,this.clearable=!0,this.showSidebar="1"===localStorage.getItem("pages:showSidebar"),this.splitter=null,this.isVisible=!0,this.favIconUrl="",this.autoUpdateInterval=10,this._autoUpdater=null,this.appName="ReplayWeb.page",this.appVersion=ge,this.appLogo=fe()}static get properties(){return{inited:{type:Boolean},sourceUrl:{type:String},loadInfo:{type:Object,attribute:!1},showSidebar:{type:Boolean},collInfo:{type:Object,attribute:!1},coll:{type:String},hasStory:{type:Boolean},isLoading:{type:Boolean},tabData:{type:Object,attribute:!1},url:{type:String},ts:{type:String},isFullscreen:{type:Boolean},menuActive:{type:Boolean},embed:{type:String},editable:{type:Boolean},browsable:{type:Boolean},clearable:{type:Boolean},isVisible:{type:Boolean},favIconUrl:{type:String},appName:{type:String},appVersion:{type:String},appLogo:{type:String},autoUpdateInterval:{type:Number}}}firstUpdated(){this.inited=!0,window.addEventListener("hashchange",(e=>this.onHashChange(e))),this.addEventListener("fullscreenchange",(()=>{this.isFullscreen=!!document.fullscreenElement})),this.embed&&(this.observer=new IntersectionObserver((e=>{this.isVisible=e[0].isIntersecting})),this.observer.observe(this))}async runUpdateLoop(){try{for(;this.editable&&this.autoUpdateInterval&&(!this.collInfo||this.collInfo.pages.length<100);)await new Promise((e=>setTimeout(e,1e3*this.autoUpdateInterval))),await this.doUpdateInfo(!0)}finally{this._autoUpdater=null}}updated(e){if(e.has("sourceUrl")&&this.doUpdateInfo(),e.has("editable")&&this.editable&&this.autoUpdateInterval&&!this._autoUpdater&&(this._autoUpdater=this.runUpdateLoop()),e.has("tabData")){if(!this.collInfo||!this.collInfo.coll)return;Object.keys(this.tabData).forEach((e=>!this.tabData[e]&&delete this.tabData[e]));const t="#"+new URLSearchParams(this.tabData).toString();if(this.tabData.url||(this.url=Bt+decodeURIComponent(this._paramsToString(this.tabData))),t!==this._locationHash){if(this._locationHash=t,this._replaceLoc||0===Object.keys(e.get("tabData")).length){const e=new URL(window.location.href);e.hash=this._locationHash,window.history.replaceState({},"",e.href),this._replaceLoc=!1}else if(window.location.hash=this._locationHash,!this.showSidebar){const e=this.renderRoot.querySelector("wr-coll-replay");e&&e.focus()}this.embed&&window.parent!==window&&window.parent.postMessage(this.tabData,"*")}this._locUpdateNeeded=!1}e.has("showSidebar")&&(this.embed||localStorage.setItem("pages:showSidebar",this.showSidebar?"1":"0")),(e.has("tabData")||e.has("showSidebar"))&&this.configureSplitter()}configureSplitter(){if(this.tabData.url&&this.showSidebar){const e=this.renderRoot.querySelector("#contents"),t=this.renderRoot.querySelector("wr-coll-replay");if(e&&t&&!this.splitter){const i={sizes:[30,70],minSize:[300,300],gutterSize:4,onDragStart(){t.setDisablePointer(!0)},onDragEnd(){t.setDisablePointer(!1)}};this.splitter=Nt([e,t],i)}}else if(this.splitter){try{this.splitter.destroy()}catch(e){}this.splitter=null}}async doUpdateInfo(e=!1){if(e&&this.tabData.url&&!this.showSidebar)return;let t=this.loadInfo&&this.loadInfo.customColl;if(!t){t=(await Ee(this.sourceUrl)).coll}this.coll=t;const i="./w/api/c/"+t,a="./w/"+t,r=await fetch(i+"?all=1");if(200!=r.status)return void(this.collInfo={});const o=await r.json();this.collInfo={apiPrefix:i,replayPrefix:a,coll:t,...o},this.collInfo.title||(this.collInfo.title=this.collInfo.filename),"replayonly"===this.embed&&(this.showSidebar=!1),this.hasStory=this.collInfo.desc||this.collInfo.lists.length,this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{collInfo:this.collInfo,alreadyLoaded:!0}})),this.onHashChange()}onCollLoaded(e){this.doUpdateInfo(),this.loadInfo=null,e.detail.sourceUrl&&(this.sourceUrl=e.detail.sourceUrl),this.dispatchEvent(new CustomEvent("coll-loaded",{detail:{sourceUrl:this.sourceUrl,collInfo:this.collInfo}}))}onCollUpdate(e){this.editable&&(this.collInfo={...this.collInfo,...e.detail})}onHashChange(){const e=window.location.hash;if(e&&e!==this._locationHash&&(this.tabData=Object.fromEntries(new URLSearchParams(e.slice(1)).entries()),this._locationHash=e),this.collInfo.coll&&!this.tabNames.includes(this.tabData.view)){const e=this.hasStory?"story":this.editable||this.collInfo.pages.length?"pages":"resources";this.tabData={...this.tabData,view:e}}if(this.tabData.url&&this.tabData.url.startsWith("page:")){const e=Number(this.tabData.url.slice("page:".length));if(!isNaN(e)&&e<this.collInfo.pages.length){const t=this.collInfo.pages[e];this.tabData.url=t.url,this.tabData.ts=Ie(t).timestamp}}this.hasStory||"story"!==this.tabData.view||(this.tabData.view="pages"),this.tabData.url&&this.tabData.query&&(this.showSidebar=!0)}onTabClick(e){e.preventDefault();const t=e.currentTarget.getAttribute("href");return this.tabData={...this.tabData,view:t.slice(1)},!1}onCollTabNav(e){e.detail.reload?this.onRefresh(null,!0):e.target.id===this.tabData.view||"replay"===e.target.id&&this.tabData.url?this.updateTabData(e.detail.data,e.detail.replaceLoc,!1):this.showSidebar&&this.tabData.url&&this.updateTabData(e.detail.data,e.detail.replaceLoc,!0)}updateTabData(e,t=!1){this.tabData={...this.tabData,...e},this.tabData.url&&(this.url=this.tabData.url||""),this.tabData.ts&&(this.ts=this.tabData.ts||""),this._replaceLoc=!this._locUpdateNeeded&&t,this._locUpdateNeeded=!0}static get styles(){return be(jt.compStyles)}static get compStyles(){return o`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
        ...
        <ul>
          ...
          <li class="sidebar-nav left">
            <a role="button" href="#" @click="${this.onHideSidebar}" @keyup="${ve}" class="is-marginless is-size-6 is-paddingless">
              <fa-icon title="Hide" .svg="${$t()}" aria-hidden="true"></fa-icon>
    ...
    <nav class="replay-bar" aria-label="replay">
      <div class="field has-addons">
        ...
        <a href="#" role="button" class="button narrow is-borderless is-hidden-mobile" @click="${this.onGoForward}" @keyup="${ve}"
          ...
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${Me()}"></fa-icon>
          </span>
        </a>
    ...
    <div class="columns">
      ...
      <div @scroll=${this.onScroll} class="column main-content main-scroll">
        <section id="list-0" class="desc">
          ...
          ${this.collInfo.desc?ne(Si(this.collInfo.desc)):""}
        </section>
        ${this.renderLists()}
      </div>
    </div>
  `}renderLists(){return U`
    ...
    `))}`}renderCPage(e){const t=new Date(e.ts),i=De(t.toISOString());return U`
    <li>
      <div class="content">
        <a @click="${this.onReplay}" data-url="${e.url}" data-ts="${i}"
          href="${Le("story",e.url,i)}">
    ...
    `}renderContent(){switch(this.state){case"googledrive":return U`<wr-gdrive .sourceUrl=${this.sourceUrl} @load-ready=${this.onLoadReady}/>`;case"started":return U`
          <div class="progress-div">
            ...
            ${this.currentSize&&this.totalSize?U`
              <div class="loaded-prog">Loaded <b>${Oe()(this.currentSize)}</b> of <b>${Oe()(this.totalSize)}</b>
              ${this.extraMsg&&U`
    ...
    <div class="search-bar notification is-marginless">
      ...
      <div class="field flex-auto">
        <div class="control has-icons-left ${this.loading?"is-loading":""}">
          ...
          <span class="icon is-left"><fa-icon .svg="${Ye()}" aria-hidden="true"></fa-icon></span>
        </div>
      </div>
    </div>
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.toDeletePages=this.toDeletePage=null}" title="Confirm Delete">
      ...
      (Size: <b>${Oe()(this.toDeletePage.size)}</b>)</p>`:U`
    ...
    </wr-modal>`:U``}isCurrPage(e){if(this.isSidebar&&e.url===this.url){let t=e.timestamp;return!t&&e.date?t=De(e.date):"string"==typeof e.ts&&(t=De(e.ts)),t===this.ts}return!1}renderPages(){return U`
        ...
        <div class="media">
          ...
          <div class="media-content ${this.isCurrent?"current":""}">
            <div role="heading" aria-level="${this.isSidebar?"4":"3"}">
              <a @dblclick="${this.onReload}" @click="${this.onReplay}" href="${Le("pages",this.page.url,this.page.timestamp)}">
        ...
        <div class="level-item flex-auto">
          ...
          <div class="field flex-auto">
            <div class="control has-icons-left ${this.loading?"is-loading":""}">
              ...
              <span class="icon is-left"><fa-icon .svg="${Ye()}"/></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <table class="all-results" aria-labelledby="results-heading num-results">
      ...
      ${this.sortedResults.length?this.sortedResults.map((e=>U`
          <tr class="columns result">
            <td class="column col-url is-6"><p class="minihead is-hidden-tablet">URL</p><a @click="${this.onReplay}" data-url="${e.url}" data-ts="${e.ts}" href="${Le("resources",e.url,e.ts)}">
    ...
    `:""}`}onLoad(e){const t=e.target.contentWindow,i=e.target.contentDocument;if(t.navigator.serviceWorker&&!t.navigator.serviceWorker.controller&&this.reloadCount<=2)return this.reloadCount++,void setTimeout((()=>t.location.reload()),100);if(this.reloadCount=0,t.customElements.get(this.mainElementName))return;const a=i.createElement("script");a.src=Ki,i.head.appendChild(a)}}!async function(){customElements.define("replay-web-page",Zi)}();var Qi=__webpack_require__(7589),Yi=__webpack_require__.n(Qi),Ji=__webpack_require__(252),Xi=__webpack_require__.n(Ji);class ea extends jt{constructor(){super(),this._sizeUpdater=null,this.totalSize=0}static get properties(){return{...jt.properties,totalSize:{type:Number}}}static get styles(){return be(ea.compStyles)}static get compStyles(){return o`
    .rec-button {
      display: flex;
      flex-direction: row;
      margin: 0 1px;
    ...
    `}updated(e){e.has("embed")&&this.embed&&!this._sizeUpdater&&(this._sizeUpdater=this.runSizeUpdater()),super.updated(e)}async runSizeUpdater(){try{for(;this.embed;){if(this.coll){const e=await fetch(`./w/api/c/${this.coll}`),t=await e.json();this.totalSize=t.size||0}await new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}renderExtraToolbar(e=!1){return this.embed?e?U`
        <a href="${pe}/c/${this.coll}/dl?format=wacz&pages=all" role="button" class="dropdown-item" @keyup="${ve}">
          <span class="icon is-small">
            <fa-icon size="1.0em" class="has-text-grey" aria-hidden="true" .svg="${at()}"></fa-icon>
          </span>
          <span>Download Archive</span>
        ...
        <span class="rec-button" title="Recording">
          <span class="icon is-small" title="Recording">
            <fa-icon size="1.2em" aria-hidden="true" .svg="${Xi()}"></fa-icon>
          </span>
          <span class="size-label">${Oe()(this.totalSize)}</span>
        </span>
        `:e?"":U`
    <a href="#" role="button"
    ...
    <div class="info-bg">
      ...
      ?detailed="${!0}"
      ></wr-rec-coll-info>
    </div>`}onShowStart(){if(this.embed)return;const e=this.coll,t=this.collInfo.title,i=this.tabData.url;this.dispatchEvent(new CustomEvent("show-start",{detail:{coll:e,title:t,url:i}}))}}customElements.define("wr-rec-coll",ea);var ta=__webpack_require__(4771),ia=__webpack_require__.n(ta),aa=__webpack_require__(2222),ra=__webpack_require__.n(aa),oa=__webpack_require__(5361),na=__webpack_require__.n(oa),sa=__webpack_require__(7848),la=__webpack_require__.n(sa);class ca extends Xe{constructor(){super(),this.detailed=!1,this.ipfsURL=null,this.shareWait=!1,this.showShareMenu=!1,this.shareWarn=!1,this.shareProgress=0}static get properties(){return{coll:{type:Object},detailed:{type:Boolean},ipfsURL:{type:String},shareWait:{type:Boolean},showShareMenu:{type:Boolean},shareWarn:{type:Boolean},shareProgress:{type:Number}}}static get styles(){return be(ca.compStyles)}static get compStyles(){return o`
    :host {
      overflow: visible;
    }
    ...
    ${Xe.compStyles}
    `}firstUpdated(){this.renderRoot.addEventListener("click",(()=>this.showShareMenu=!1))}updated(e){e.has("coll")&&this.coll&&("main.archive"===this.coll.id&&"local://main.archive"!==this.coll.sourceUrl&&(this.coll={...this.coll,sourceUrl:"local://main.archive"}),this.coll.ipfsPins&&this.coll.ipfsPins.length&&(this.ipfsURL=this.coll.ipfsPins[this.coll.ipfsPins.length-1].url))}render(){const e=this.coll,t=this.detailed,i=localStorage.getItem("ipfsLocalURL");return U`
      <div class="columns">
        ...
        <div class="column is-2">
          ...
          <div class="button-row is-flex">
            <a href="${pe}/c/${this.coll.id}/dl?format=wacz&pages=all" class="button is-small" title="Download">
              <span class="icon is-small">
                <fa-icon aria-hidden="true" .svg="${at()}"></fa-icon>
              </span>
            </a>
            <button @click="${this.onShowImport}" class="button is-small" title="Import Archive...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${je()}"></fa-icon>
              </span>
            </button>
            <button @click="${this.onShowStart}" class="button is-small" title="Start Recording...">
              <span class="icon">
                <fa-icon aria-hidden="true" .svg="${Xi()}"></fa-icon>
              </span>
            </button>
          </div>
        </div>
                  ...
                  <div class="dropdown-menu" id="dropdown-menu" role="menu" style="z-index: 100">
                    <div class="dropdown-content">
                      ...
                      <a @click="${this.onCopyIPFSLink}" class="dropdown-item">
                        <span class="icon is-small">
                          <fa-icon size="0.8em" .svg="${ra()}"></fa-icon>
                        </span>
                        Copy IPFS URL
                      </a>
        ...
        ${e.loadUrl}
        <a @click="${t=>this.onCopy(t,e.loadUrl)}" class="copy"><fa-icon .svg="${We()}"/></a>
        </div>`:""}
      </div>
      ${this.shareWarn?this.renderShareWarn():""}
      `}renderShareWarn(){return U`
    ...
    <wr-modal bgClass="has-background-grey-lighter" @modal-closed="${()=>this.deleteConfirm=null}" title="Confirm Delete">
      ...
      (Size: <b>${Oe()(this.deleteConfirm.size)}</b>)</p>
      ...
      ${Ne.appStyles}
    `)}get mainLogo(){return ha()}renderNavEnd(){return U`
    <a href="https://archiveweb.page/guide" target="_blank" class="navbar-item is-size-6">
    <fa-icon .svg="${Ue()}" aria-hidden="true"></fa-icon><span>&nbsp;User Guide</span>
          ...
          <div class="message-body">
            <div class="buttons">
              ...
              <button class="button is-small no-pad-mobile" title="Start Recording..." ?disabled="${!this.colls}" @click="${this.onShowStart}">
                <span class="icon">
                  <fa-icon size="1.0em" aria-hidden="true" .svg="${Xi()}"></fa-icon>
                </span>
    ...
    <wr-modal .noBgClose=${!0} style="--modal-width: 740px" @modal-closed="${()=>this.showDownloadProgress=!1}" title="Download Progress">
      <div class="dl-progress">
        ...
        <div>Size Downloaded: <b>${Oe()(this.download.currSize)}</b></div>
            ...
            <section class="modal-card-body">
              <div class="container">
                <div class="content">
                  <div class="is-flex">
                    <div class="has-text-centered" style="width: 220px">
                      <fa-icon class="logo" size="48px" .svg="${ha()}"></fa-icon>
                      <div style="font-size: smaller; margin-bottom: 1em">${this.getDeployType()} v${pa}</div>
                    </div>
